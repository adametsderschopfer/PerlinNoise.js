export namespace Perlin {
	...
	const grad3: Array<Grad> = [new Grad(1, 1, 0), new Grad(-1, 1, 0), new Grad(1, -1, 0), new Grad(-1, -1, 0),
	...
	const perlin: Array<number> = [151, 160, 137, 91, 90, 15,
	...
	* */
	...
	export class Noise /*implements IPerlinNoise*/ {
		static perlin2(x: number, y: number): number {
			...
			return linearInterpolation(
				linearInterpolation(n00, n10, u),
				linearInterpolation(n01, n11, u),
				fade(y));
		};
		...
		static perlin3(x: number, y: number, z: number): number {
			...
			return linearInterpolation(
				linearInterpolation(
					linearInterpolation(n000, n100, u),
					linearInterpolation(n001, n101, u), w),
				linearInterpolation(
					linearInterpolation(n010, n110, u),
					linearInterpolation(n011, n111, u), w),
				v);
		};
	}
}
